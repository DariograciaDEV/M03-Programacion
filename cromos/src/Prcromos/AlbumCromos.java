...
public class AlbumCromos {
    ...
    private void anyadirOpcionesMenu(Menu cromos_menu) {
        ...
        cromos_menu.AddOption(new OptionItem("Mostrar Repes"));
    }
    ...
    private void listadoAlbum(CromoDAO album) {
    ...
    private void listadoRepes(CromoDAO album) {
        //ArrayList<Cromo> nuevos_album = (ArrayList<Cromo>) album.getAlbum();
        ...
        System.out.println("Cromos en el album:" + album.getNumRepes());
    }
}
